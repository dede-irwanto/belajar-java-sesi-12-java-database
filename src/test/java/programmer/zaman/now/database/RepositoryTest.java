...
public class RepositoryTest {
    ...
    @Test
    void testInsert() {
        Comment comment = new Comment("dede@test.com", "hi");
    ...
    void testFindById() {
        ...
        Comment notFound = commentRepository.findById(5);
    ...
    void testFindByEmail() {
        List<Comment> comments = commentRepository.findAllByEmail("dede@test.com");
        System.out.println(comments.size());
    }
}
